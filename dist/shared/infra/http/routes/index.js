...
var companies_routes_1 = __importDefault(require("@modules/Company/http/routes/companies.routes"));
var jobs_routes_1 = __importDefault(require("@modules/Company/http/routes/jobs.routes"));
...
routes.use('/jobs', jobs_routes_1.default);
